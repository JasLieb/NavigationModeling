...
/**
 * This is the item provider adapter for a {@link org.lpdql.parcours.Point} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNomPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Point_nom_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Point_nom_feature", "_UI_Point_type"),
						ParcoursPackage.Literals.POINT__NOM, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Point) object).getNom();
		return label == null || label.length() == 0 ? getString("_UI_Point_type")
	...
	public void notifyChanged(Notification notification) {
		...
		case ParcoursPackage.POINT__NOM:
