 ...
 * @generated
 */
public class NavigationModelingSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public NavigationModelingSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case NavigationModelingPackage.PAROURS_RAPIDE: {
			ParoursRapide paroursRapide = (ParoursRapide) theEObject;
			T result = caseParoursRapide(paroursRapide);
			if (result == null)
				result = caseIParcours(paroursRapide);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case NavigationModelingPackage.IPARCOURS: {
			IParcours iParcours = (IParcours) theEObject;
			T result = caseIParcours(iParcours);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case NavigationModelingPackage.PAROURS_COURT: {
			ParoursCourt paroursCourt = (ParoursCourt) theEObject;
			T result = caseParoursCourt(paroursCourt);
			if (result == null)
				result = caseIParcours(paroursCourt);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parours Rapide</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parours Rapide</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParoursRapide(ParoursRapide object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>IParcours</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IParcours</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIParcours(IParcours object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parours Court</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parours Court</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParoursCourt(ParoursCourt object) {
		return null;
	}
